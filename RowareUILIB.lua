-- just an edit of this ui lib https://raw.githubusercontent.com/AlexR32/Roblox/main/BracketV3.lua

if game:GetService("CoreGui"):FindFirstChild("ROWARE") then
  game:GetService("CoreGui"):FindFirstChild("ROWARE"):Remove()
end
